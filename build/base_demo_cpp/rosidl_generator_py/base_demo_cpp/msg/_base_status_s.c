...
bool base_demo_cpp__msg__base_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_demo_cpp.msg._base_status.BaseStatus", full_classname_dest, 41) == 0);
  }
  base_demo_cpp__msg__BaseStatus * ros_message = _ros_message;
  {  // seq
  ...
  {  // cmd_timeout
    PyObject * field = PyObject_GetAttrString(_pymsg, "cmd_timeout");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->cmd_timeout = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of BaseStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_demo_cpp.msg._base_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseStatus");
  ...
  {  // cmd_timeout
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->cmd_timeout ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cmd_timeout", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
